import { imgGroup214 } from "./svg-k2zze";

export default function Apps() {
  return (
    <div
      className="relative box-border flex size-full content-stretch items-start gap-[100px] bg-[#043873] px-[32px] py-[140px]"
      data-name="Apps"
      data-node-id="547:8583"
    >
      <div
        className="h-[470px] w-[582px] shrink-0 bg-[#c4defd]"
        data-name="Image-container"
        data-node-id="547:9128"
      />
      <div
        className="relative flex min-h-px min-w-px shrink-0 grow basis-0 flex-col content-stretch items-start gap-[60px]"
        data-name="Heading"
        data-node-id="547:8728"
      >
        <div
        ...
        >
          ...
          <div
            ...
            data-name="Icon"
            data-node-id="547:8734"
          >
            <div
              className="relative size-[14px] shrink-0"
              data-node-id="547:8735"
            >
